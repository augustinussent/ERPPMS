# Roadmap setelah Hotel PMS v1.1.0

## Production gate tetap wajib

v1.1.0 tidak menggantikan v1.0 Production Gate. Blank install, upgrade rehearsal, accounting reconciliation, concurrency, security, performance, restore drill, parallel run, dan departmental sign-off tetap harus diselesaikan sebelum tag final production.
