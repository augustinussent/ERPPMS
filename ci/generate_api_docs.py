...
openapi={'openapi':'3.1.0','info':{'title':'Hotel PMS API','version':'1.1.0'},'paths':paths,'components':{'securitySchemes':{'tokenAuth':{'type':'apiKey','in':'header','name':'Authorization'}}},'security':[{'tokenAuth':[]}]}
